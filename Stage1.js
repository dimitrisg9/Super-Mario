var Stage1 = {
		...
		create: function() {
            ...
            //new staff(squirtle)
            squirtle = game.add.group();
			squirtle.enableBody = true;
			map.createFromTiles(1, null, 'squirtle', 'enemy', squirtle);
			squirtle.callAll('animations.add', 'animations', 'walkRight',[ 0, 1 ],2, true);
            ...
            deadsound = game.add.sound('dead');
            backsound = game.add.sound('background');
            backsound.loop = true;
            backsound.play();
